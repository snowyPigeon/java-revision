...
A Main class, a Garden class and a Blackbird class. The Garden and Blackbird classes have properties, the details of wich are output to the screen when the main method is run.
